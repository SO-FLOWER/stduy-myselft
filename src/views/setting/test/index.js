...
class ProAssigend extends Component {
  constructor(props){
    ...
    this.state={
        ...
        pageNum :1,
        allCount : 0,
        ww:[{roleId: 1, deptId: 145554519, roleName: "主管理员", deptName: "深圳提亚数字科技有限公司", createBy: "张三"},
    ...
    componentDidMount(){
        ...
        this.setState({tableData:this.getTableData(1, 10, this.state.tableData)})
       let data =  {
            "current": 1,
            "size": 10,
                                ...
                                <div className='pmContent' >
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            {
                                           this.state.ww.map((item, index) => {
                                              return (
                                              <tr  key={index}>
                                                {
                                                Object.keys(item).map((td,i)=> <td key={i}><input type="text"  placeholder={
                                                  item[td]
                                                } value=''/></td>)
